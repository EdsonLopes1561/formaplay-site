    ...
    <section id="conheca" className={styles.section}>
      <div className={`container ${styles.container}`}>
        <div className={styles.header}>
          <h2 className={styles.title}>Conheça a FormaPlay</h2>
          <p className={styles.subtitle}>Educação que transforma. Diversão que ensina.</p>
        </div>
        
        <div className={styles.content}>
          <p className={styles.text}>
            A FormaPlay nasceu com o propósito de transformar o aprendizado em uma experiência mais prática, envolvente e significativa. Unindo educação, estratégia e diversão, desenvolvemos jogos educacionais que aproximam teoria e prática de forma dinâmica.
          </p>
          <p className={styles.text}>
          ...
          <p className={styles.text}>
            Hoje, a FormaPlay segue evoluindo com o objetivo de criar soluções educacionais para estudantes, professores, instituições e empresas.
          </p>
        </div>
        ...
        <div className={styles.timeline}>
          ...
          <div className={styles.timelineItem}>
            <div className={styles.dot}></div>
            <div className={styles.timelineContent}>
              <h4>Evolução da FormaPlay como marca de jogos educacionais</h4>
            </div>
          </div>
        </div>
      </div>
